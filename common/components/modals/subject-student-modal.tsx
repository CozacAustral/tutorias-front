import { Box, Button, HStack, Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Text, VStack } from "@chakra-ui/react";
...
const SubjectModal: React.FC<SubjectStudentModal> = ({
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} isCentered>
            ...
            >
                <Text fontSize="35px" color='black' marginTop='40px' marginLeft={10} marginRight={8} marginBottom={1}>
                    <Text as='span' fontWeight='bold'>Editar: </Text>{titleCareer}
                </Text>
                <ModalCloseButton />
                <ModalBody paddingY={6} display="flex" flexDirection="column" minH={0}>
